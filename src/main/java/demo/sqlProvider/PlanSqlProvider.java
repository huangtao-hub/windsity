...
public class PlanSqlProvider {
	...
	public String planaddDay() {
//		String sql = "INSERT INTO USERTABLE (username, passwork, phone, address, idcard, age, sex, email, nickname) VALUES (#{username}, #{passwork}, #{phone}, #{address}, #{idcard}, #{age}, #{sex}, #{email}, #{nickname})";
		String sql = "INSERT INTO plan_day (username, passwork) VALUES (#{username}, #{passwork})";
		return sql;
	}

	public String loginuser() {
		String sql = "SELECT PASSWORK FROM USERTABLE WHERE username=#{username}";
